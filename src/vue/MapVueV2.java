...
public class MapVueV2 implements Observer{
	JFrame frame;
	 ...
	 */
	public MapVueV2(Desk desk,Player player1,VirtuelPlayer player2 ){
		initialize();
	 ...
	 */
	public static void mapvuev2Main() {
